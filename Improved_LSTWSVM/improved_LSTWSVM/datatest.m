    ...
    clear all;
    close all;
     file1 = fopen('results_Improved_LSTWSVM.txt','w+');
     file2 = fopen('results_c_mu_Improved_LSTWSVM.txt','w+');
...
%    initialize minimum error variable and corresponding c
    min_c1 = 1.;min_c3 = 1.;min_c2=min_c1;min_c4=min_c3;
                ...
                for cii=1:length(cvs3)
                    ...
                    %   training statement
                     ...
                     while ((part+1)* block_size) <= m
                        ...
                        c2=c1;c4=c3;
                        FunPara.c1=c1;FunPara.c2=c2;FunPara.c3=c3;FunPara.c4=c4;FunPara.kerfPara.type = 'lin';
                        [err]= Improved_LSTWSVM(Data_test,Data,FunPara,Energy);
                        fprintf(file2, 'example file %s; err= %8.6g, part num= %8.6g,c1= %8.6g, c2= %8.6g,c3= %8.6g,c4= %8.6g,\n',...
                             file,err,part,c1,c2,c3,c4);
                        avgerr = avgerr + err;
                        part=part+1;
                     end
                      fprintf(file2, 'example no: %s\t avgerr: %g\t c1=%g\t c2=%g c3=%g c4=%g\n',file, avgerr,c1,c2,c3,c4);
                     if (avgerr<min_err)
...
% %    _______________________________________________________________________
     FunPara.c1=min_c1;FunPara.c2=min_c2;FunPara.c3=min_c3;FunPara.c4=min_c4;
     FunPara.kerfPara.type = 'lin';
     tstart=tic;
     [err,Predict_Y,w1,b1,w2,b2]=Improved_LSTWSVM(TestX,DataTrain,FunPara);
     telapsed(load_file)=toc(tstart);
     

    fprintf(file1,'example file: %s;err = %8.6g of %g,c1 = %8.6g,c2 = %8.6g c3=%8.6g, c4=%8.6g\n', ...
                 file,err,length(Predict_Y),FunPara.c1,FunPara.c2,FunPara.c3,FunPara.c4);
    end
