function [Predict_Y,err,w1,b1,w2,b2,distan] = Improved_LSTWSVM(TestX,DataTrain,FunPara)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Improved_LSTWSVM: Improved Least Square Twin Support Vector Machine
% Y. Xu, W. Xi, X. Lv, R. Guo (2012) An improved least squares twin support vector machine. J. Inf & Comput Sci 9:1063-1071
%
